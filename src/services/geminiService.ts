...
if (!API_KEY) {
  ...
  // However, for API keys, it's better to have a clear error if it's missing.
  // This check remains useful. The key should be in a .env file at the root.
  // e.g., VITE_API_KEY=your_key_here
  // and accessed via import.meta.env.VITE_API_KEY
