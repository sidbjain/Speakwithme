        ...
        <main className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full p-3 bg-slate-800/60 border border-slate-700 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-shadow duration-200 appearance-none bg-no-repeat"
              style={{
